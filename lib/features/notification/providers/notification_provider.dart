...
class NotificationListNotifier
  ...
  NotificationListNotifier(this._service, this._unreadOnly)
  ...
  Future<void> load() async {
    ...
    try {
      ...
      state = AsyncData(_filterExpired(items));
  ...
  Future<void> markAsRead(String id) async {
    ...
    await _service.markAsRead(id, cancelToken: _cancelToken);
...
List<NotificationModel> _filterExpired(List<NotificationModel> items) {
