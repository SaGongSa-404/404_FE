...
class _TermsPolicyScreenState extends State<TermsPolicyScreen> with SingleTickerProviderStateMixin {
  ...
  // [통일] 소비 관리 및 다른 화면들과 완전히 일치하는 연한 회색 배경색
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        top: false, // 커스텀 앱바 포지셔닝 제어를 위해 상단 제한 해제
        child: Column(
          children: [
            // [수정] 고정 높이(126)를 제거하고 패딩 구조로 변경하여 탭바와의 거리를 콤팩트하게 밀착
            Container(
              width: double.infinity,
              color: _backgroundColor,
              padding: const EdgeInsets.only(left: 30, right: 30, top: 54, bottom: 16), // 위쪽 여백은 유지하되 아래 여백 축소
              child: Stack(
            ...
            // [수정] 이용약관 / 개인정보 처리방침이 담긴 탭바 배경을 연한 회색(_backgroundColor)으로 통일
            Container(
              color: _backgroundColor,
              child: TabBar(
  ...
  // 1. 위굴 서비스 이용약관 데이터 뷰 (원문자 기호 1. 2. 3. 전면 수정 완료)
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildParagraphTitle('제 3 조 (서비스의 제공 및 내용)'),
          _buildParagraphBody(
          ...
          _buildParagraphTitle('제 4 조 (게시물 및 데이터의 관리, 악성 유저 제재)'),
          _buildParagraphBody(
          ...
          _buildParagraphTitle('제 5 조 (외부 서비스 연동 및 면책 조항)'),
          _buildParagraphBody(
          ...
          _buildParagraphTitle('제 6 조 (회원 탈퇴 및 데이터 처리)'),
          _buildParagraphBody(
          ...
          _buildParagraphTitle('제 7 조 (서비스의 변경 및 중지)'),
          _buildParagraphBody(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildParagraphTitle('1. 수집하는 개인정보의 항목 및 수집 방법'),
          _buildParagraphBody(
          ...
          _buildParagraphTitle('2. 개인정보의 수집 및 이용 목적'),
          _buildParagraphBody(
  ...
  Widget _buildParagraphTitle(String title) {
    return Padding(
  ...
  Widget _buildParagraphBody(String body) {
    return Text(
      body,
      style: const TextStyle(
        fontSize: 13,
